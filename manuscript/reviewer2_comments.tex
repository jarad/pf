...
We recognize the limitations of the models presented in our paper and, as you point out, focus instead on methodological development. We have added to Section 7 a discussion of the shortcomings of SMC, the advantages of PMCMC, and we propose a strategy that takes advantage of both approaches in order to explore the potential for online tracking in complex modeling situations. \\
