...
Thank you for this valuable suggestion as well as the information regarding the pomp package. We found the pmcmc function easy to use and re-ran a full MCMC analysis on data accumulated every 5th day of the simulated epidemic. The results compared well with those from the Liu \& West approach, and we've updated Section 5.6.2 accordingly. \\
