...
Thank you for this valuable suggestion as well as the information regarding the pomp package. We found the pmcmc function easy to use and re-ran a full MCMC analysis using the full data set as well as data from the first 30, 60, and 90 days. The results compared well with those from the Liu \& West approach, and we've updated Section 5.6.2 accordingly. \\
