...
\end{minipage}
\caption{Simulated epidemic curves (left) and syndromic observations (right) for a single simulated epidemic (colored lines) and curves for $i_t$ from other simulations (light gray). True values of unknown parameters used for simulation were $\beta = 0.254$, $\gamma = 0.111$, and $\nu = 1.246$.} \label{fig:data}
\end{figure}
