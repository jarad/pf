...
The behavior of the BF, APF, and KDPF shown in Figure \ref{fig:pfs} is consistent across the 40 simulations. For fixed $J \ge 1000$, 50\% credible intervals calculated from the marginal filtered distributions of each unknown parameter at $t = 125$ cover the truth for roughly half of the simulations using the KDPF, while for the BF and APF they cover the truth for at most 15\% of simulations.
