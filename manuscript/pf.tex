...
The behavior of the BF, APF, and KDPF shown in Figure \ref{fig:pfs} is consistent across the 40 simulations. For instance, for $J = 20000$, the 95\% credible intervals at $t = 125$ for each of $\beta$, $\gamma$ and $\nu$ cover the truth for 19 out of 20 simulations using the KDPF. The BF and APF using the same number of particles, on the other hand, have at most 7 simulations for which 95\% credible intervals for one of the unknown parameters at $t = 125$ covers the truth.
