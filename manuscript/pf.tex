...
Table \ref{tab:mcmc} shows that 95\% credible intervals calculated from the marginal filtered distributions of the model parameters using the KDPF with $J = 20000$ particles compare well with those calculated from the samples generated by PMCMC. Both methods are asymptotically justified (the KDPF as $J$ gets large and PMCMC as the number of iterations gets large). However, while the PMCMC on the full data set took 8-9 hours to run, the KDPF with $J = 20000$ particles provided results in about 15 minutes.
...
\hline
30 & MCMC & 0.1930 & 0.2550 & 0.0911 & 0.1455 & 0.9413 & 1.2898 \\
   & KDPF & 0.1897 & 0.2511 & 0.0893 & 0.1400 & 0.9475 & 1.2916 \\
\hline
60 & MCMC & 0.2254 & 0.2465 & 0.1142 & 0.1343 & 0.9926 & 1.2949 \\
   & KDPF & 0.2262 & 0.2480 & 0.1157 & 0.1354 & 0.9818 & 1.2516 \\
\hline
90 & MCMC & 0.2346 & 0.2415 & 0.1218 & 0.1310 & 1.0046 & 1.2108 \\
   & KDPF & 0.2336 & 0.2427 & 0.1217 & 0.1319 & 0.9955 & 1.2046 \\
\hline
125 & MCMC & 0.2347 & 0.2406 & 0.1218 & 0.1289 & 1.0390 & 1.2128 \\
