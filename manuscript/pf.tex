...
The bootstrap filter (BF), auxilliary particle filter (APF), and kernel density particle filter (KD) were each run using $J = 100, 1000, 10000, \mbox{ and } 20000$ particles to obtain weighted sample approximations to $p(x_t,\theta|y_{1:t})$ for $t = 1,\ldots,T$.  For a comparison of resampling schemes, this process was carried out using multinomial, residual, stratified, and then systematic resampling.  For each resampling technique, an effective sample size threshold of 0.8 was used.  For the kernel density particle filter, the tuning parameter $\delta$ was set to 0.99.
...
\begin{figure}[ht]
\centering
\caption*{$\mbox{uniform priors} \qquad \mbox{systematic resampling}$}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-uniform-systematic-100-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-uniform-systematic-1000-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-uniform-systematic-10000-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-uniform-systematic-20000-n}
\end{minipage}
\caption{Displays medians (solid lines) and 2.5\%/97.5\% quantiles (dashed lines) of the filtered distributions of the unknown parameters over time.}
\end{figure}

\begin{figure}[ht]
\centering
\caption*{$\mbox{normal priors} \qquad $J = 1000$ \mbox{ particles}$}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-multinomial-1000-resamp}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-residual-1000-resamp}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-stratified-1000-resamp}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-systematic-1000-resamp}
\end{minipage}
\caption{Displays medians (solid lines) and 2.5\%/97.5\% quantiles (dashed lines) of the filtered distributions of the unknown parameters over time.}
\end{figure}
...
\begin{figure}[ht]
\centering
\caption*{$\mbox{normal priors} \qquad $J = 10000$ \mbox{ particles}$}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-multinomial-10000-resamp}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-residual-10000-resamp}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-stratified-10000-resamp}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-systematic-10000-resamp}
\end{minipage}
\caption{Displays medians (solid lines) and 2.5\%/97.5\% quantiles (dashed lines) of the filtered distributions of the unknown parameters over time.}
\end{figure}
...
\includegraphics[width=1.0\textwidth]{Hist-contour-KD-normal-stratified-10000-betagamma}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\caption*{uniform priors}
\includegraphics[width=1.0\textwidth]{Hist-contour-KD-uniform-stratified-10000-betagamma}
\end{minipage}
\caption{Contour plots of the joint kernel density estimate of $\beta$ and $\gamma$ at $t = 15, 30, 45,\ldots,120$ days.  The kernel density particle filter was used with $J = 10000$ particles and stratified resampling.}
\end{figure}
...
\begin{minipage}{1.0\linewidth}
\caption*{normal priors}
\includegraphics[width=1.0\textwidth]{Hist-KD-normal-stratified-10000-betagamma}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\caption*{uniform priors}
\includegraphics[width=1.0\textwidth]{Hist-KD-uniform-stratified-10000-betagamma}
\end{minipage}
\caption{Scatterplots of $\beta$ versus $\gamma$ with values taken from their joint filtered distributions at $t = 15, 30, 45,\ldots,120$ days.  The kernel density particle filter was used with $J = 10000$ particles and stratified resampling.}
\end{figure}

\begin{figure}[ht]
\centering
\caption*{$\mbox{normal priors} \qquad \mbox{stratified resampling}$}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-stratified-100-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-stratified-1000-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-stratified-10000-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-stratified-20000-n}
\end{minipage}
\caption{Displays medians (solid lines) and 2.5\%/97.5\% quantiles (dashed lines) of the filtered distributions of the unknown parameters over time.}
\end{figure}
...
\caption*{$\mbox{normal priors} \qquad \mbox{stratified resampling}$}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-st-normal-stratified-100-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-st-normal-stratified-1000-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-st-normal-stratified-10000-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-st-normal-stratified-20000-n}
\end{minipage}
\caption{Displays medians (solid lines) and 2.5\%/97.5\% quantiles (dashed lines) of the filtered distributions of the unknown parameters over time.}
\end{figure}
...
\caption*{$\mbox{normal priors} \qquad \mbox{stratified resampling}$}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-obs-normal-stratified-100-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-obs-normal-stratified-1000-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-obs-normal-stratified-10000-n}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-obs-normal-stratified-20000-n}
\end{minipage}
\caption{Displays medians (solid lines) and 2.5\%/97.5\% quantiles (dashed lines) of the filtered distributions of the unknown parameters over time.}
\end{figure}
