...
\danny{We should just move this whole discussion up to Section \ref{sec:advice}}
...
\end{equation}
\danny{i think we should introduce this in Section \ref{sec:model} and then say $\eta_l=0$ when doing the simulations.}
