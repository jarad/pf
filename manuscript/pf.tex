...
\includegraphics[width=1.0\textwidth]{PF-params-1Pbeta-100}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-1Pgamma-100}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-1Pbeta-1000}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-1Pgamma-1000}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-1Pbeta-10000}
\end{minipage}
\begin{minipage}{0.45\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-1Pgamma-10000}
\end{minipage}
...
\includegraphics[width=1.0\textwidth]{PF-params-2P-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-2P-1000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-2P-10000}
\end{minipage}
...
\includegraphics[width=1.1\textwidth]{../PF-D0/PF-params-100}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{../PF-D1/PF-params-100}
\end{minipage}
\begin{minipage}{1.1\linewidth}
...
\begin{figure}[ht]
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{../PF-D0/PF-params-1000}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{../PF-D1/PF-params-1000}
\end{minipage}
\begin{minipage}{1.1\linewidth}
...
\begin{figure}[ht]
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{../PF-D0/PF-params-10000}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{../PF-D1/PF-params-10000}
\end{minipage}
\begin{minipage}{1.1\linewidth}
...
\begin{figure}[ht]
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D0/PF-states-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D1/PF-states-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
...
\begin{figure}[ht]
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D0/PF-states-1000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D1/PF-states-1000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
...
\begin{figure}[ht]
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D0/PF-states-10000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D1/PF-states-10000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
...
\begin{figure}[ht]
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{../PF-D0/PF-params-med-100-100}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{../PF-D1/PF-params-med-100-100}
\end{minipage}
\begin{minipage}{1.1\linewidth}
...
\begin{figure}[ht]
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D0/PF-states-med-100-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D1/PF-states-med-100-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
...
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D1/PF-states-med-1F-100-100}
\end{minipage}
...
\begin{figure}[ht]
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D1/PF-params-med-100-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{../PF-D1/PF-params-med-1F-100-100}
\end{minipage}
\caption{Each panel displays the median (solid colored lines) and 2.5\%/97.5\% quantiles (dashed colored lines) over time of 100 medians of the filtered distributions of unknown parameters over time using the observation equation above the graphs in figure \ref{fig:kappa} with $\kappa = 1$ for $J = 100$ particles. In the top graphs, $\sigma_l$ was set to 5 times the values given in table \ref{tab:true}, and in the bottom graphs, $\sigma_l$ was set to the actual values given in table \ref{tab:true}.}
\end{figure}
...
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.2\textwidth]{PF-params-med-100-100}
\end{minipage}
...
\centering
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-states-6P-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-states-6P-1000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-states-6P-10000}
\end{minipage}
...
\centering
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{PF-params-6P-100}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{PF-params-6P-1000}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{PF-params-6P-10000}
\end{minipage}
\caption{Each panel displays medians (solid colored lines) and 2.5\%/97.5\% quantiles (dashed colored lines) over time for the filtered distributions of the unknown parameters (columns) using (top to bottom) $J = 100, 1000, \mbox{ and } 10000$ particles.  Different colors represent the different particle filter methods, and horizontal solid black lines show the true value of the parameters used to simulate the data.} \label{fig:params6P}
\end{figure}
...
\centering
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{PF-params-6P-op-100}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{PF-params-6P-op-1000}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.1\textwidth]{PF-params-6P-op-10000}
\end{minipage}
...
\centering
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-states-med-6P-100-100}
\end{minipage}
\begin{minipage}{1.1\linewidth}
\includegraphics[width=1.2\textwidth]{PF-params-med-6P-100-100}
\end{minipage}
\caption{Each panel displays the median (solid colored lines) and 2.5\%/97.5\% quantiles (dashed colored lines) over time of 100 medians of the filtered distributions of the states (top) and unknown parameters (bottom).  Different colors represent the different particle filter methods using $J = 100$ particles.  In the top two panels, black solid and dashed lines represent the median and 2.5\%/97.5\% quantiles of the true simulated $i$ and $s$, and horizontal solid black lines in the bottom three panels show the true value of the parameters used to simulate the data.} \label{fig:meds}
\end{figure}
