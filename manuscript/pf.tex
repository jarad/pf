...
\includegraphics[width=1.0\textwidth]{PF-params-uniform-systematic-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-uniform-systematic-1000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-uniform-systematic-10000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-uniform-systematic-20000}
\end{minipage}
\caption{Displays 2.5\%/97.5\% quantiles of the filtered distributions of the unknown parameters over time.}
\end{figure}
...
\end{minipage}
\caption{Scatterplots of $\beta$ versus $\gamma$ with values taken from their joint filtered distributions at $t = 15, 30, 45,\ldots,120$ days.  The kernel density particle filter was used with $J = 10000$ particles and systematic resampling.}
\end{figure}

\begin{figure}[ht]
\centering
\caption*{$\mbox{normal priors}$}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-KD-100}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-KD-1000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-KD-10000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-KD-20000}
\end{minipage}
\caption{Displays 2.5\%/97.5\% quantiles of the filtered distributions of the unknown parameters over time.}
\end{figure}
...
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-normal-stratified-10000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-states-normal-stratified-10000}
\end{minipage}
\caption{Displays medians 2.5\%/97.5\% quantiles of the filtered distributions of the unknown parameters and states over time.}
\end{figure}
...
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-st-normal-stratified-20000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-params-ext-obs-normal-stratified-20000}
\end{minipage}
\begin{minipage}{1.0\linewidth}
\includegraphics[width=1.0\textwidth]{PF-states-ext-normal-stratified-20000}
\end{minipage}
\caption{Displays 2.5\%/97.5\% quantiles of the filtered distributions of the unknown parameters and states over time.}
\end{figure}
