...
\usepackage{amsmath,natbib,verbatim,color,graphicx,caption}
...
\begin{figure}[ht]
\centering
\includegraphics[height=4in]{../Graphs/PF/PF-quant-1000}
...
\caption*{$k = 25$ Days}
\includegraphics[width=1.0\textwidth]{../Graphs/PF/Hist-KD-1000-day25}
\end{minipage}
\begin{minipage}[b]{.4\linewidth}
\caption*{$k = 154$ Days}
\includegraphics[width=1.0\textwidth]{../Graphs/PF/Hist-KD-1000-day154}
\end{minipage}
...
\begin{figure}[ht]
\centering
\includegraphics[height=5in]{../Graphs/PF/EpidPred-KD-1000}
