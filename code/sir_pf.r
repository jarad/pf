...
require(plyr)
mydata = expand.grid(n = c(100, 1000, 10000), filt = "KD", resamp = "systematic", prior = "semi-normal", progress=TRUE, nonuniformity="ess", threshold=0.8, stringsAsFactors=FALSE)
m_ply(mydata,pf)
