...
data1 = expand.grid(n = n, states = c(FALSE), stringsAsFactors = FALSE)
data2 = expand.grid(n = n, states = c(TRUE), stringsAsFactors = FALSE)
require(plyr)
coverage1 <- maply(data1, my_pf_coverage)
coverage2 <- maply(data2, my_pf_coverage)