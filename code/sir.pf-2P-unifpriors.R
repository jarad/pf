...
thetal = c(0.1400, 0.0900)
thetau = c(0.5000, 0.1430)
...
revo_bf = function(x){ revo(x, P, d, c(theta2u(x[3:4],thetal,thetau),theta[3]))}
rprior_bf = function()
{ 
...
pstate_apf = function(x) { revo(x, P, d, c(theta2u(x[3:4],thetal,thetau),theta[3]), FALSE)}
revo_apf = function(x){ revo(x, P, d, c(theta2u(x[3:4],thetal,thetau),theta[3]))}
rprior_apf = function()
{ 
  myprior = rprior(sim$y[,1], rtheta, b, varsigma, sigma, dpower)
  return(c(myprior$x,myprior$theta))
...
pstate_kd = function(x, mytheta) { revo(x, P, d, c(theta2u(mytheta,thetal,thetau),theta[3]), FALSE)}
revo_kd = function(x, mytheta){ revo(x, P, d, c(theta2u(mytheta,thetal,thetau),theta[3]))}
